...
def render_html(case: dict) -> str:
    ...
    parts.append(f"<title>Specie — Case {_esc(case.get('case_ref', ''))}</title>")
    parts.append("""<style>
      :root{--p:#6D28D9;}
    ...
    parts.append("<header>")
    parts.append("<h1>&#128994; Specie &mdash; Counter-Threat-Finance Case File</h1>")
    ...
    parts.append("<p class='muted'>Generated by Specie &middot; "
